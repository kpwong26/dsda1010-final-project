...
- Each boxplot shows the **summary distribution** of each attribute (token count, toxicity, sentiment, and readability score) in posts with **GPT-like** and **human** model signatures
