...
# Generative AI Misinformation Research Final Report {.unnumbered}
## STAT/DSDA 1010; Data Science and Society Using R {.unnumbered}
**Karissa Wong**
...
### Findings
::: {layout-ncol=1 fig-post="H"}
![AI Posts by Country](countries-ai-posts.png){width=75% #fig-country fig-subcap="AI Posts by Country"}
:::
...
![Engagement with Human Content](human-engagement.png){width=75% #fig-human fig-subcap="Engagement with Human Content"}

![Engagement with AI Content](ai-engagement.png){width=75% #fig-ai fig-subcap="Engagement with AI Content"}
:::
...
::: {layout-ncol=2 fig-pos="H"}
![Misinformation in Human Posts](human-misinformation.png){width=75% #fig-human fig-subcap="Misinformation in Human Posts"}

![Misinformation in AI Posts](ai-misinformation.png){width=75% #fig-ai fig-subcap="Misinformation in AI Posts"}
:::
...
conclude a statistically significant difference given a significance level of 0.05.

## Attributes of Misinformation Detection
::: {layout-ncol=1 fig-post="H"}
![Post Attributes](attributes.png){width=65% #fig-attributes fig-subcap="Post Attributes"}
:::
...
there is a statistically significant difference given a significance level of 0.05.
...
conclude there is a statistically significant difference given a significance level of 0.05.
...
to conclude there is a statistically significant difference given a significance level of 0.05.
